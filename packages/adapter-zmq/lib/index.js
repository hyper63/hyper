...
module.exports = function (port) {
    ...
    return {
        ...
        link: function (env) {
             ...
             */
            return function (a) { return __awaiter(_this, void 0, void 0, function () { var _a, _b, _c; return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!a) return [3 /*break*/, 2];
                        _b = merge;
                        _c = [a];
                        return [4 /*yield*/, adapter(env)];
                    case 1:
                        _a = _b.apply(void 0, _c.concat([_d.sent()]));
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, adapter(env)];
                    case 3:
                        _a = _d.sent();
                        _d.label = 4;
